...
def main():
    ...
    <div class="page-header">
        <h1 class="page-title">Parent Activities</h1>
    </div>
    """, unsafe_allow_html=True)
    
    # Family showcase section
    st.markdown("""
    <div class="family-section">
        <h2 class="highlight-text">Strengthening Home-School Connections</h2>
        <div class="family-showcase">
            <div class="family-card">
                <img src="/attached_assets/Exam-Students_1750847086459.jpg" alt="Family learning">
                <h4>Daily Tracking</h4>
                <p>Monitor your child's learning progress with simple, effective tools</p>
            </div>
            <div class="family-card">
                <img src="/attached_assets/Exam-Students_1750847086459.jpg" alt="Parent support">
                <h4>Parent Empowerment</h4>
                <p>Gain insights and strategies to support learning at home</p>
            </div>
            <div class="family-card">
                <img src="/attached_assets/Exam-Students_1750847086459.jpg" alt="Family collaboration">
                <h4>School Partnership</h4>
                <p>Build strong communication bridges with your child's teachers</p>
            </div>
            <div class="family-card">
                <img src="/attached_assets/Exam-Students_1750847086459.jpg" alt="Student success">
                <h4>Student Success</h4>
                <p>Celebrate achievements and address challenges together</p>
            </div>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    if not child_name:
        st.warning("Please enter your child's name in the sidebar to begin tracking.")
        st.stop()

    if dashboard_view == "Daily Entry":
        st.markdown("## Daily Observation Entry")
        st.markdown(f"Recording observations for **{child_name}** on {date.today().strftime('%B %d, %Y')}")
        ...
        with st.form("daily_observation_form"):
            ...
            with col2:
                ...
                behavior_rating = st.slider(
                    "Overall Behavior (1-5)", 
                    1, 5, 3,
                    help="1=Challenging, 3=Average, 5=Excellent"
                )
                
                mood_rating = st.slider(
                    "Mood/Emotional State (1-5)", 
                    1, 5, 3,
                    help="1=Very Upset, 3=Neutral, 5=Very Happy"
                )
