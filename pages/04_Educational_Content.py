...
st.set_page_config(
    page_title="Educational Content",
    page_icon="⭕",
    layout="wide"
)
...
def main():
    ...
    <div class="content-section">
        <h2 class="highlight-text">Building Educational Excellence Through Research</h2>
        <div class="research-showcase">
            <div class="research-card">
                <img src="/attached_assets/Exam-Students_1750847086459.jpg" alt="Educational research">
                <h4>Global Best Practices</h4>
                <p>International standards and methods adapted for Somali educational environments</p>
            </div>
            <div class="research-card">
                <img src="/attached_assets/Exam-Students_1750847086459.jpg" alt="Learning research">
                <h4>Learning Science</h4>
                <p>Neuroscience and cognitive research on how children learn most effectively</p>
            </div>
            <div class="research-card">
                <img src="/attached_assets/Exam-Students_1750847086459.jpg" alt="Intervention studies">
                <h4>Intervention Studies</h4>
                <p>Evidence-based strategies for supporting students with learning challenges</p>
            </div>
            <div class="research-card">
                <img src="/attached_assets/Exam-Students_1750847086459.jpg" alt="Cultural education">
                <h4>Cultural Adaptation</h4>
                <p>Research on implementing inclusive education in diverse cultural contexts</p>
            </div>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    with st.sidebar:
        ...
        st.markdown("### Group Target Audience")
        audience = st.selectbox(
            "Content for:",
            ["Teachers", "Parents", "Administrators", "All"]
        )
