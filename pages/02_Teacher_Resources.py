...
def main():
    ...
    <div class="page-header">
        <h1 class="page-title">Teacher Resources</h1>
    </div>
    """, unsafe_allow_html=True)
    ...
    <div class="teacher-header">
        <h1>Excellence in Somali Education</h1>
        <h2>Empowering Teachers with Evidence-Based Learning Support Strategies</h2>
        <p style="font-size: 1.2em; opacity: 0.9;">
            Professional development resources designed for inclusive classroom success
        </p>
    </div>
    """, unsafe_allow_html=True)
    ...
    <div class="resource-section">
        <h2 class="highlight-text">Supporting Every Teacher, Reaching Every Student</h2>
        <div class="teacher-showcase">
            <div class="teacher-card">
                <img src="/attached_assets/Exam-Students_1750847086459.jpg" alt="Inclusive classroom">
                <h4>Inclusive Classroom Excellence</h4>
                <p>Create learning environments where every student thrives through differentiated instruction</p>
            </div>
            <div class="teacher-card">
                <img src="/attached_assets/Exam-Students_1750847086459.jpg" alt="Teacher collaboration">
                <h4>Professional Collaboration</h4>
                <p>Build strong partnerships with families and specialists for comprehensive student support</p>
            </div>
            <div class="teacher-card">
                <img src="/attached_assets/Exam-Students_1750847086459.jpg" alt="Student engagement">
                <h4>Engaging Learning Strategies</h4>
                <p>Implement culturally responsive teaching methods that connect with Somali students</p>
            </div>
            <div class="teacher-card">
                <img src="/attached_assets/Exam-Students_1750847086459.jpg" alt="Assessment strategies">
                <h4>Assessment Innovation</h4>
                <p>Use multiple assessment methods to accurately gauge student progress and needs</p>
            </div>
        </div>
    </div>
    """, unsafe_allow_html=True)
