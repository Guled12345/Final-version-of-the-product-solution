...
def render_dashboard_page_content():
    ...
    render_exact_page_header(get_material_icon_html("dashboard"), 'Dashboard', 'Comprehensive Learning Analytics Platform', language)
    ...
    with chart_col1:
        ...
        st.markdown(create_exact_chart_container(
            ...
            "Average scores across all core academic subjects",
        ), unsafe_allow_html=True)
    ...
    with chart_col2:
        ...
        st.markdown(create_exact_chart_container(
            f"{get_material_icon_html('pie_chart')} Student Risk Assessment Distribution",
            "Overview of student learning risk levels",
        ), unsafe_allow_html=True)
    ...
    st.markdown(create_exact_chart_container(
        ...
        "Latest student assessment data and risk evaluations"
    ), unsafe_allow_html=True)
    ...
    st.markdown(create_exact_chart_container(
        ...
        "Track average subject performance changes over time"
    ), unsafe_allow_html=True)
    ...
    fig_line.update_layout(
        ...
        xaxis=dict(gridcolor='var(--gray-200)', showgrid=True, title="Time Period"),
        yaxis=dict(gridcolor='var(--gray-200)', showgrid=True, range=[65,90], title="Average Score (%)")
    )
